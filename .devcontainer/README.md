...
- **Tools**:
  ...
  - **Node**: Required by VS Code extensions (OXC, etc.)
...
Edit `.mise.toml` to update Bun, Node, or Hugo versions. All environments (this devcontainer, CI) pick up the change automatically.
